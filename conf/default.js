...
module.exports = {
	...
	// API key
	apikey: '77irp6cpSESgtMXPDS2kqwSQIehf8PcN',
	...
	// Base64 encoded username:password.  Also requires `accessControl.ldap` options (object).
	...
	session: {
		...
		encryptionKey: '2U6+mooCFeMe9K+erP6XQYl1WXwj948WQ5nztdidJLg=',
		signatureAlgorithm: 'sha512-drop256',
		signatureKey: '5HbilCaeN4+z1Y7na0yV7YKipmEK3AJ9e1DJLBF3PNdw0TCZJFrTLej0d0Q0XkqogNWwXvShoFxHVBraWlXgJA==',
		secret: '0ojT2RZJQGRJ61P0jkYp8N+YArtjg6rt', // should be a large unguessable string
	...
	cookieSecret: '33lgxnbdIe6l5cT2mbOWVCLHq4WAuK+D',
